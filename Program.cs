...
builder.Services.AddDbContext<Contexto>(options =>
    options.UseSqlServer("Server=souFIEB.mssql.somee.com;Database=souFIEB;User Id=odarkaraujo_SQLLogin_1;Password=souFieb1;Connect Timeout=20;Encrypt=False;TrustServerCertificate=False"));
